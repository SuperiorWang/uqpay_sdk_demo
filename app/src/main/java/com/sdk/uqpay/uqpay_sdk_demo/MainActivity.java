package com.sdk.uqpay.uqpay_sdk_demo;
...
public class MainActivity extends AppCompatActivity implements Callback, Runnable {
    ...
    private final View.OnClickListener tnOnClickListener = new View.OnClickListener(){
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tnBtn = (Button)findViewById(R.id.button_tn);
        tnBtn.setTag(0);
        payBtn = (Button)findViewById(R.id.button_pay);
        editText = (EditText)findViewById(R.id.edit_tn);

        mContext = this;
        mHandler = new Handler(this);
        tnBtn.setOnClickListener(tnOnClickListener);
